...
from lowformer.apps.utils import (
    dist_init,
    dump_config,
    get_dist_local_rank,
    get_dist_rank,
...
from lowformer.models.utils import build_kwargs_from_config, load_state_dict_from_file
...
def setup_dist_env(gpu: str or None = None) -> None:
    # os.environ['MASTER_ADDR'] = 'localhost' by Moritz
