...
def repvit_pretrained(modelname, cls=True):
    model = eval(modelname+"()")
    # https://github.com/THU-MIG/RepViT/releases/download/v1.0/repvit_m0_9_distill_300e.pth
    ckurl = "https://github.com/THU-MIG/RepViT/releases/download/v1.0/repvit_"+modelname+"_distill_300e.pth"
    checkpoint = torch.hub.load_state_dict_from_url(
        ckurl, map_location='cpu', check_hash=True)
    ...
    for k in ['head.l.weight', 'head.l.bias',
        ...
        if k in checkpoint_model and checkpoint_model[k].shape != state_dict[k].shape and not cls:
