...
class MobileViG(torch.nn.Module):
    ...
    def forward(self, inputs):
        ...
        for ind,i in enumerate(self.local_backbone):
            x = i(x)
            
        # for i in range(len(self.backbone)):
        #     x = self.backbone[i](x)
        for ind, i in enumerate(self.backbone):
            x = i(x)
...
def get_mobile_vig(version):
    # "https://huggingface.co/SLDGroup/MobileViG/resolve/main/MobileViG_B_82_6.pth.tar?download=true"
    # "https://huggingface.co/SLDGroup/MobileViG/resolve/main/MobileViG_M_80_7.pth.tar?download=true"
    # "https://huggingface.co/SLDGroup/MobileViG/resolve/main/MobileViG_S_78_2.pth.tar?download=true"
    # "https://huggingface.co/SLDGroup/MobileViG/resolve/main/MobileViG_Ti_75_7.pth.tar?download=true"
    #... mobile vig
    model = eval("mobilevig_"+ version+"()")
    return model
